...
Appointment _appointmentFromJson(Map<String, dynamic> json) => Appointment(
  ...
  expectedDuration: Duration(minutes: json['expectedDurationMinutes'] as int),
  type:
      _enumOrNull(AppointmentType.values, json['type'] as String?) ??
      AppointmentType.other,
  status:
      _enumOrNull(AppointmentStatus.values, json['status'] as String?) ??
...
Ride _rideFromJson(Map<String, dynamic> json) => Ride(
  ...
  scheduledPickupAt: DateTime.parse(
    json['scheduledPickupAt'] as String,
  ).toLocal(),
  flexibleReturn: json['flexibleReturn'] as bool? ?? false,
  status:
      _enumOrNull(RideStatus.values, json['status'] as String?) ??
...
TrackingPoint _trackingPointFromJson(Map<String, dynamic> json) =>
    TrackingPoint(
...
AppNotification _notificationFromJson(Map<String, dynamic> json) =>
    AppNotification(
      id: json['id'] as String,
      kind:
          _enumOrNull(NotificationKind.values, json['kind'] as String?) ??
