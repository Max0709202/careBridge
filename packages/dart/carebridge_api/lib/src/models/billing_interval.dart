...
/// BillingInterval, as the API spells it.
enum BillingInterval {
  monthly('monthly'),
  annual('annual');

  const BillingInterval(this.wireName);
  ...
  static BillingInterval fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('BillingInterval', value),
  );
}
