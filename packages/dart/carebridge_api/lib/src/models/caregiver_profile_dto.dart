...
/// CaregiverProfileDto, from the CareBridge API.
class CaregiverProfileDto {
  const CaregiverProfileDto({
    required this.id,
  ...
  final List<AvailabilityWindowDto> availability;

  final List<ReviewDto> reviews;

  factory CaregiverProfileDto.fromJson(
    ...
    availability: (json['availability'] as List<dynamic>)
        .map((e) => AvailabilityWindowDto.fromJson(e as Map<String, dynamic>))
        .toList(),
