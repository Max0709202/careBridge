...
/// CaregiverStatus, as the API spells it.
enum CaregiverStatus {
  ...
  const CaregiverStatus(this.wireName);
  ...
  static CaregiverStatus fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('CaregiverStatus', value),
  );
}
