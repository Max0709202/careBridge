...
/// ConfigurableChannel, as the API spells it.
enum ConfigurableChannel {
  email('email'),
  push('push');

  const ConfigurableChannel(this.wireName);
  ...
  static ConfigurableChannel fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () =>
        throw CareBridgeUnknownEnumValue('ConfigurableChannel', value),
  );
}
