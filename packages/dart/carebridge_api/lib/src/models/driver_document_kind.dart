...
/// DriverDocumentKind, as the API spells it.
enum DriverDocumentKind {
  ...
  const DriverDocumentKind(this.wireName);
  ...
  static DriverDocumentKind fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('DriverDocumentKind', value),
  );
}
