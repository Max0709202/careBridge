...
/// DriverDocumentStatus, as the API spells it.
enum DriverDocumentStatus {
  ...
  const DriverDocumentStatus(this.wireName);
  ...
  static DriverDocumentStatus fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () =>
        throw CareBridgeUnknownEnumValue('DriverDocumentStatus', value),
  );
}
