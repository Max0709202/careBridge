...
/// DriverStatus, as the API spells it.
enum DriverStatus {
  invited('invited'),
  ...
  const DriverStatus(this.wireName);
  ...
  static DriverStatus fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('DriverStatus', value),
  );
}
