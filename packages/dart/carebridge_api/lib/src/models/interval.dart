...
/// Interval, as the API spells it.
enum Interval {
  monthly('monthly'),
  annual('annual');

  const Interval(this.wireName);
  ...
  static Interval fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('Interval', value),
  );
}
