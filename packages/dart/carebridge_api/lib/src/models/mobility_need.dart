...
enum MobilityNeed {
  ...
  escortToDoor('escortToDoor'),
  lowVision('lowVision'),
  hardOfHearing('hardOfHearing'),
  memorySupport('memorySupport');

  const MobilityNeed(this.wireName);
  ...
  static MobilityNeed fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('MobilityNeed', value),
  );
}
