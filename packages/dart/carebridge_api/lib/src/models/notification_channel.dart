...
/// NotificationChannel, as the API spells it.
enum NotificationChannel {
  inApp('inApp'),
  email('email'),
  push('push');

  const NotificationChannel(this.wireName);
  ...
  static NotificationChannel fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () =>
        throw CareBridgeUnknownEnumValue('NotificationChannel', value),
  );
}
