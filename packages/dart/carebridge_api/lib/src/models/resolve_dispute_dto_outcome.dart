...
/// ResolveDisputeDtoOutcome, as the API spells it.
enum ResolveDisputeDtoOutcome {
  upheld('upheld'),
  refunded('refunded'),
  waived('waived');

  const ResolveDisputeDtoOutcome(this.wireName);
  ...
  static ResolveDisputeDtoOutcome fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () =>
        throw CareBridgeUnknownEnumValue('ResolveDisputeDtoOutcome', value),
  );
}
