...
/// SeatChange, as the API spells it.
enum SeatChange {
  granted('granted'),
  released('released');

  const SeatChange(this.wireName);
  ...
  static SeatChange fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('SeatChange', value),
  );
}
