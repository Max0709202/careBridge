...
/// SubscriptionStatus, as the API spells it.
enum SubscriptionStatus {
  ...
  const SubscriptionStatus(this.wireName);
  ...
  static SubscriptionStatus fromJson(String value) => values.firstWhere(
    (e) => e.wireName == value,
    orElse: () => throw CareBridgeUnknownEnumValue('SubscriptionStatus', value),
  );
}
